...
if (empty($email)) {
    ...
    $resultset = Database::search("SELECT * FROM `student` WHERE `username`='" . $username . "' AND `password`='" . $password . "';");

    if ($resultset->num_rows == 1) {
        echo "This Username already Exists!!!";
    } else {

        Database::iud("INSERT INTO `student`(`username`,`password`,`email`,`grade_id`,`status_id`,`verification_status_id`,`verification_code`) VALUES('" . $username . "','" . $password . "','" . $email . "','" . $grade . "','1','2','" . $verification_code . "');");
        ...
        $bodyContent = '<h1 style="color: rgb(68, 210, 111); font-weight: bold;">Student Invitation</h1> 
                                ...
                                <br/>
                                <a href="http://localhost/osms/signIn.php?user=teacher" style="color: rgb(68, 210, 111); font-size: 17px;">Click Here To Sign In</a>';
