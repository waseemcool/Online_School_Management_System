...
$rs = Database::search("SELECT * FROM `teacher` WHERE `id` = '" . $_SESSION["teacher"]["id"] . "'");
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-3 text-center">
            <div class="row">
                ...
                $prs = Database::search("SELECT * FROM `teacher_photo` WHERE `teacher_id` = '" . $details["id"] . "'");
...
<div class="col-12 mt-5" style="margin-bottom: 208px;">
    <div class="row justify-content-center">
        <div class="col-3 d-grid">
            <button class="btn kur-btn fw-bold" onclick="UpdateTeacherProfile();">Save Changes</button>
        </div>
    </div>
</div>