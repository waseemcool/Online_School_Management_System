                    ...
                    <div class="col-2 kur-box" style="border-bottom: none; border-top: none; border-left: none;">
                        <div class="row">
                            ...
                            <div class="col-12 mt-2" style="text-align: center;">
                                ...
                                <label class="text-primary fs-5">Student</label>
                            </div> -->
                            
                            <div class="col-12" style="margin-top: 320px;">
                                <button class="kur-btn2" style="width: 282px; font-size: 18px;" onclick="loadVN();"><i><img src="resources/addlessonnotes.png" 
                                style="width: 34px; height: 34px;"/></i>&nbsp;&nbsp;View Lesson Notes</button>
                            </div>
                            <div class="col-12 mt-3">
                                <button class="kur-btn2" style="width: 282px; font-size: 18px;" onclick="loadAss();"><i><img src="resources/assignments.png" 
                                style="width: 34px; height: 34px;"/></i>&nbsp;&nbsp;Assignments</button>
                            </div>
                            <div class="col-12 mt-3">
                                <button class="kur-btn2" style="width: 282px; font-size: 18px;" onclick="loadStudentProfile();"><i><img src="resources/profile1.png" 
