...
<body onload="loadAllAcademicOfficers();">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12" style="background-color: rgb(240, 240, 240);">
                                        <div class="row">
                                            ...
                                            <div class="col-12 mt-3">
                                                <h4 class="text-primary fw-bold" style="margin-left: 40px;">Academic Officers</h4>
                                            </div>

                                            <div class="col-12 mt-4">
                                                <div class="row justify-content-center" id="ao">
                                                    ...
                                                    <div class="col-6 bg-white" style="height: 470px; border-radius: 15px; margin-left: 53px;">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 text-center mt-3">
                                                                <h4 class="text-primary fw-bold">Academic Officer Register and Invite</h4>
                                                            </div>
                                                                ...
                                                                <div class="row justify-content-center">
                                                                    ...
                                                                    <div class="col-10">
                                                                        ...
                                                                        <div class="input-group">
                                                                            <input type="text" class="form-control fs-5 border-radius" style="font-size: 20px;" id="e"/>
                                                            ...
                                                            <div class="col-12 mt-5">
                                                                <div class="row justify-content-center">
                                                                    <div class="col-10 d-grid">
                                                                        <button class="btn kur-btn fs-5" onclick="aoRegSendInvitation();">Register & Send Invitation</button>
                                                                    </div>
                                                                </div>
                                                            </div>
