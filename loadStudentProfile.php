...
$rs = Database::search("SELECT * FROM `student` WHERE `id` = '" . $_SESSION["student"]["id"] . "'");
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-3 text-center">
            <div class="row">
                ...
                $prs = Database::search("SELECT * FROM `student_photo` WHERE `student_id` = '" . $details["id"] . "'");
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        $grs = Database::search("SELECT * FROM `grade` WHERE `id` = '" . $details["grade_id"] . "'");
                        $g = $grs->fetch_assoc();
                        ...
                        <div class="col-6 mt-3">
                            ...
                            <input value="<?php echo $g["name"]; ?>" class="form-control" style="font-size: 17px;" disabled />
                            </select>
                        </div>
...
<div class="col-12 mt-5" style="margin-bottom: 119px;">
    <div class="row justify-content-center">
        <div class="col-3 d-grid">
            <button class="btn kur-btn fw-bold" onclick="UpdateStudentProfile();">Save Changes</button>
        </div>
    </div>
</div>